...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener respondToClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.sb_btn1:
                    mp = MediaPlayer.create(context, R.raw.fouragain);
                    mp.setVolume(100,100);
                    mp.start();

                    break;
                case R.id.sb_btn2:
                    mp = MediaPlayer.create(context, R.raw.bowledhim);
                    mp.start();

                    break;
               // case R.id.sb_btn3:
                 //   mp = MediaPlayer.create(context, R.raw.greatshot);
                   // mp.start();
                   // break;
                case R.id.sb_btn4:
                    mp = MediaPlayer.create(context, R.raw.thatisawide2);
                    mp.start();
                    break;
                case R.id.sb_btn5:
                    mp = MediaPlayer.create(context, R.raw.thatsagoodshot);
                    mp.start();
                    break;

               // case R.id.sb_btn6:
               //     mp = MediaPlayer.create(context, R.raw.thatsasix2);
               //     mp.start();
              //      break;
                case R.id.sb_btn7:
                    mp = MediaPlayer.create(context, R.raw.whatasix);
                    mp.start();
                    break;
               // case R.id.sb_btn8:
                 //   mp = MediaPlayer.create(context, R.raw.stadium);
                  //  mp.start();
                   // break;
              //  case R.id.sb_btn9:
